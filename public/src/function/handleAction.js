...
import { addObstacleToCostMap } from "../class/Human/Human";
 ...
 */
export function handleClickSquare(x, y) {
...
function addAsset(newAsset, isObstacle) {
    ...
    if (isObstacle)
        addObstacleToCostMap(newAsset.pos);
}
/**
 * addHumanボタンをクリックした際の処理を行う
 */
export function handleAddHumanClick() {
